...
namespace fw {
	...
	public:
		...
		//テキスト描画(1バイト文字)
		virtual void drawText(std::float32_t* const point, const StringU8& text, const TextAttr& textAttr) = 0;
		//テキスト描画(2バイト文字)
		virtual void drawText(std::float32_t* const point, const StringU16& text, const TextAttr& textAttr) = 0;
