...
namespace dw {
	...
	std::int32_t DWImageBMP::create(std::uint8_t* const bmp, const std::int32_t bmpSize)
	{
		...
		if ((fileType[0] == 'B') && (fileType[1] == 'M')) {
			...
			if (infoHeaderSize == BIH_HEADERSIZE) {
				//Windowsフォーマット
				this->format_ = BitmapFormat::WINDOWS;
	...
	std::string DWFunc::getFilePath_TimeNumImage(const std::char8_t timeNumber, DWImageFormat& format)
	{
		...
		switch (timeNumber) {
		case '0':	filePath = filePath + "0_zero.png";		break;
		case '1':	filePath = filePath + "1_one.png";		break;
		case '2':	filePath = filePath + "2_two.png";		break;
		case '3':	filePath = filePath + "3_three.png";	break;
		case '4':	filePath = filePath + "4_four.png";		break;
		case '5':	filePath = filePath + "5_five.png";		break;
		case '6':	filePath = filePath + "6_six.png";		break;
		case '7':	filePath = filePath + "7_seven.png";	break;
		case '8':	filePath = filePath + "8_eight.png";	break;
		case '9':	filePath = filePath + "9_nine.png";		break;
		case ':':	filePath = filePath + "sym_colon.png";	break;
		default:	break;
		}
		format = DWImageFormat::PNG;
		return filePath;
	}
}
